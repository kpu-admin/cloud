...
import cn.lmx.kpu.shop.granter.CaptchaTokenMemberGranter;
import cn.lmx.kpu.shop.properties.CaptchaProperties;
...
public class CaptchaServiceImpl implements CaptchaService {
    ...
    public void createImg(String key, HttpServletResponse response) throws IOException {
        ...
        CacheKey cacheKey = CaptchaCacheKeyBuilder.build(key, CaptchaTokenMemberGranter.GRANT_TYPE);
    ...
    public R<Boolean> sendSmsCode(String mobile, String templateCode) {
        if (MsgTemplateCodeEnum.REGISTER_SMS.eq(templateCode)) {
            // 查user表判断重复
            boolean flag = memberUserService.checkMobile(mobile, null);
