...
public class SopIsvKeysSaveVO implements Serializable {
    ...
    @NotEmpty(message = "请填写开发者生成的私钥 （提供给开发者）")
    @Size(max = 65535, message = "开发者生成的私钥 （提供给开发者）长度不能超过{max}")
    private String privateKeyIsv;
    /**
     * 平台生成的公钥 （提供给开发者）
     */
    @Schema(description = "平台生成的公钥 （提供给开发者）")
    @NotEmpty(message = "请填写平台生成的公钥 （提供给开发者）")
    @Size(max = 65535, message = "平台生成的公钥 （提供给开发者）长度不能超过{max}")
