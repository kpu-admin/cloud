...
public class RouterMeta extends LinkedHashMap<String, Object> implements Serializable {
    ...
    @Schema(description = "内嵌iframe的地址 By Kpu")
    public String getIframe() {
        return Convert.toStr(this.get(routerMetaConfig.getIframeKey()));
    }
    ...
    @Schema(description = "vben5 And Kpu 外链地址")
    ...
    @Schema(description = "隐藏该路由在面包屑上面的显示 By Kpu")
    public Boolean getBreadcrumb() {
        return Convert.toBool(this.get(routerMetaConfig.getBreadcrumbKey()));
    }
    ...
    @Schema(description = "当前路由不再菜单显示 By Kpu")
    public Boolean getMenu() {
        return Convert.toBool(this.get(routerMetaConfig.getMenu()));
    }

    public RouterMeta setMenu(Boolean menu) {
        this.put(routerMetaConfig.getMenu(), menu);
        return this;
    }
